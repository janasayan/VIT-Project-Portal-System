...
mongoose.connect("mongodb+srv://sayan:sayan@inshort.pssw3.mongodb.net/?retryWrites=true&w=majority", { useNewUrlParser: true,useUnifiedTopology: true,useFindAndModify:false});
  ...
  newproject.save(function(err){
   if(!err){
    req.user.projects.push(newproject._id);
     req.user.save();
     setTimeout(function(){     res.redirect("/projects")},3000);
   }
  });
})
